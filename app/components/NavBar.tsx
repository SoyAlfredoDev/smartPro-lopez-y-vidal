                  ...
                  {navItems.map((item, index) =>
                    item.isButton ? (
                      <motion.a
                        ...
                        onClick={() => setOpen(false)}
                        className="mt-3 inline-flex items-center justify-center rounded-full border border-[#c9a961]/35 bg-[linear-gradient(180deg,rgba(201,169,97,0.18),rgba(201,169,97,0.08))] px-5 py-3 text-sm font-medium text-[#f5efe4] transition-all duration-300 hover:border-[#e6d19a]/55 hover:bg-[linear-gradient(180deg,rgba(201,169,97,0.24),rgba(201,169,97,0.12))]"
                      >
                        {item.label}
                      </motion.a>
                    ) : (
